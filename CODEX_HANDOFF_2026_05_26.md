...
- `package_breakdown_rsi_v1` completed: best accepted `+74.43%`, PF `1.596`, DD `5.16%`, one negative month. `package_arf1_flat_touch_v1` finished `48/48`; winner `r002` (`ARF1_MIN_RSI=48`, `ARF1_REJECT_BELOW_RES_ATR=0.08`, `ARF1_RES_TOUCH_BUFFER_ATR=0.35`) replayed successfully: five slots `+77.57%`, PF `1.646`, DD `5.16%`, 419 trades, 2 negative months; matching current three-slot concurrency `+67.11%`, PF `1.530`, DD `4.82%`, 432 trades, 2 negative months versus three-slot baseline `+62.79%`, PF `1.478`, DD `5.36%`, 3 negative months. Use `configs/crypto_income_arf1_r002_strict3_shadow_candidate.env` as review-only candidate. Do not alter live until strict four-sleeve/fixed-symbol policy and capped total/same-direction risk are explicitly approved.
