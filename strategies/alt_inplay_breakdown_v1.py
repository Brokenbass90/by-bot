...
class AltInplayBreakdownV1Strategy:
    ...
    def __init__(self, cfg: Optional[AltInplayBreakdownV1Config] = None):
        ...
        self.cfg.min_rr = _env_float("BREAKDOWN_MIN_RR", self.cfg.min_rr)
        self.cfg.min_stop_pct = _env_float("BREAKDOWN_MIN_STOP_PCT", self.cfg.min_stop_pct)
        self.cfg.max_stop_pct = _env_float("BREAKDOWN_MAX_STOP_PCT", self.cfg.max_stop_pct)
        ...
        self.cfg.trail_atr_mult = _env_float("BREAKDOWN_TRAIL_ATR_MULT", self.cfg.trail_atr_mult)
        self.cfg.trail_activate_rr = _env_float("BREAKDOWN_TRAIL_ACTIVATE_RR", self.cfg.trail_activate_rr)
    ...
    def _signal_from_entry_bar(self, store, rows_5m: List[list]) -> Optional[TradeSignal]:
        ...
        actual_rr = (entry - tp2) / max(1e-12, risk)
