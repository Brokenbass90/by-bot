...
| 2026-03-03 | `backtest/run_portfolio.py` + `docs/rd_cleanup_candidates.csv` | generated `docs/cleanup_gap_report.csv` | detect what blocks archive phase | safe phased cleanup without breaking imports | found 33 archive candidates still statically imported (must prune first) | yes |
