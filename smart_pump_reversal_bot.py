        ...
        try:
            ...
            _diag_payload = {
                ...
                "portfolio": {
                    ...
                    "risk_per_trade_pct": round(float(RISK_PER_TRADE_PCT or 0.0), 6),
                    "base_risk_per_trade_pct": round(float(BASE_RISK_PER_TRADE_PCT or 0.0), 6),
                    "orch_global_risk_mult": round(float(ORCH_GLOBAL_RISK_MULT or 0.0), 6),
                    "allocator_enable": bool(PORTFOLIO_ALLOCATOR_ENABLE),
                    "allocator_safe_mode": bool(ALLOCATOR_SAFE_MODE),
                    "allocator_hard_block": bool(ALLOCATOR_HARD_BLOCK_NEW_ENTRIES),
                    "allocator_global_risk_mult": round(float(ALLOCATOR_GLOBAL_RISK_MULT), 6),
                    "max_open_portfolio_risk_pct": round(float(MAX_OPEN_PORTFOLIO_RISK_PCT or 0.0), 6),
                    "max_positions": int(MAX_POSITIONS),
