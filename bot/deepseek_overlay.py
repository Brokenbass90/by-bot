...
class DeepSeekOverlay:
    ...
    def ask(self, question: str, snapshot: dict[str, Any]) -> str:
        ...
        system_prompt = (
            ...
            "5. alt_inplay_breakdown_v1 — SHORT breakdowns на BTC/ETH/SOL.\n"
            "   Trailing stop: off (fixed exit, оптимальнее по бэктестам).\n"
            "   Бэктест 360d: net=+34.85%, WR=54.8%, 157 trades, DD=2.4%, 0 красных месяцев.\n"
            "   Статус: ENABLE_BREAKDOWN_TRADING=1 ✅ АКТИВНА.\n\n"
            "== ПОРТФЕЛЬ (360d backtest, сессия 10) ==\n"
            "$100 → $200.93 (+100.93%), PF=2.08, DD=3.65%, 446 trades, 0 красных месяцев из 12.\n\n"
            "== AUTORESEARCH ==\n"
