...
class DeepSeekOverlay:
    ...
    def ask(self, question: str, snapshot: dict[str, Any]) -> str:
        ...
        system_prompt = (
            ...
            "  - snapshot.ai_full_context.setup_cards_top — топ-12 свежих setup-карточек с reasons; это то, что видит web AI как «скриннер».\n"
            "  - snapshot.ai_full_context.grouped_no_signal и snapshot.crypto_blocker — почему сетапы блокируются (фильтры, символ, allocator).\n"
