...
ASB1 (шорт)        Пробой поддержки    3.0:1  ~0.9/день  🟢 READY 0.50×
TS132              Любой               2.0:1  ~3/день    ⏳ WF не запущен
pump_fade_v4r      Волатильный         1.5:1  ~1-2/день  ⏳ WF не запущен
```

ATT1 + Elder v2 + ASB1 = **~3.6 сделки/день на 4 символах**.
Три разных типа сигнала → низкая корреляция → меньше просадок.
- ATT1: ловит тренды и отскоки
- Elder: MACD-импульс в подтверждённом даунтренде
- ASB1: пробои восходящих поддержек вниз
