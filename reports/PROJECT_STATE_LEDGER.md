...
- Session commits pushed through `e286534`: fail-closed ATT1 contract, dynamic heartbeat truth, canonical/freshness-aware AI context, truth-first web/weekly reports, Alpaca reports/watchdog and pump-exhaustion successor. Local/origin `e286534`; VPS remains `f7ed011`, now 22 commits behind. None of these session changes were deployed; existing Alpaca safe-hold and ATT1 `0.10` live behavior remain unchanged.
