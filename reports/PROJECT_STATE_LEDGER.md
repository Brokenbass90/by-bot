...
- Added portfolio-wide health monitor `bot/portfolio_health.py`, alert-only by default. `PORTFOLIO_HEALTH_ENABLE=1`, `PORTFOLIO_HEALTH_AUTOCUT=0`. It writes `runtime/portfolio_health.json`; future auto-cut wiring must be reviewed sleeve-by-sleeve.
