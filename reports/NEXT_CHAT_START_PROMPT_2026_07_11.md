...
- Implementation/research checkpoint `202aead` (`codex/dynamic-symbol-filters`) совпадает с origin; documentation checkpoint идёт следом, поэтому current local/origin HEAD всё равно проверь командой. Новые commits: `3818a0a`, `f95cd3e`, `e919ec3`, `202aead`.
...
1. Не тюнить и не включать ARS1/ASB2/Elder. Для выбранного pump-exhaustion short materialize/hash-pin frozen 720d inputs и повторить strict preflight; performance до PASS запрещён.
