...
- Из screenshot symbols AKE/BANK/US теперь действительно увидены и scored; LYN rejected по turnover `$640.5k < $1m`. AKE/BANK/US в эту точку времени не прошли event gate, поэтому старые картинки не превратились в hindsight-сигналы.
...
- Новые local/Git AI maps в `72dc6c2` валидны, но targeted install на VPS не выполнен: archive только staged в remote `/tmp`, approval usage limit остановил установку. Server AI всё ещё видит прежний `de06ad8` design-gap. Receipt: `reports/releases/CANONICAL_EVENT_ACTIVE_DEPLOY_BLOCKED_72DC6C2_2026_07_18.json`.
