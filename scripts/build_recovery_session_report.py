...
def build_artifact() -> dict:
    ...
    scenarios = [
        ...
        },
        {
            ...
            "stage": "RESEARCH_REPLAY_REQUIRED",
            "initial_usd": 1000.0,
            "illustrative_end_usd": None,
            "range_usd": None,
            "red_months": "unknown after causal correction",
            "basis": "prior 7.5-9.5% figures revoked: signal close was also used as entry close",
            "admissibility": "NO_ESTIMATE",
            "blocker": "next-open replay, funding cashflows and closed-contract PIT all required",
        },
        {
