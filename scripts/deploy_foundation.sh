...
FILES=(
  ...
  "configs/elder_v2_shorts_canary.env"
  "configs/midterm_v3_canary.env"
  ...
  "strategies/btc_eth_midterm_v3.py"
  "strategies/btc_eth_midterm_short_v2.py"
  ...
  "scripts/codex_deploy_20260416.sh"
  "scripts/build_geometry_state.py"
  "scripts/build_operator_snapshot.py"
  "scripts/build_ai_full_context.py"
  "scripts/build_ai_extras.py"
  "scripts/build_ai_ohlc_and_logs.py"
  "scripts/build_crypto_setup_blocker_report.py"
  "scripts/build_self_audit_report.py"
  ...
  "scripts/run_dynamic_crypto_walkforward.py"
  "scripts/run_crypto_rehab_queue.sh"
  ...
  "scripts/run_crypto_rehab_multiyear_queue.py"
  "scripts/run_crypto_rehab_multiyear_queue.sh"
  ...
  "scripts/run_midterm_short_v2_backtests.sh"
  "scripts/run_elder_v3_wf22.sh"
  "scripts/run_ts132_wf22.sh"
  ...
  "configs/operator_capabilities.json"
  "configs/portfolio_allocator_policy.json"
  "configs/strategy_health.json"
  "configs/crypto_rehab_multiyear_queue.json"
...
$SSH_CMD "cd $BOT_DIR && PYTHON_BIN=.venv/bin/python; [ -x \"\$PYTHON_BIN\" ] || PYTHON_BIN=\$(command -v python3); PYTHONDONTWRITEBYTECODE=1 \"\$PYTHON_BIN\" -c \"import importlib; mods=['smart_pump_reversal_bot','bot.health_gate','bot.operator_snapshot','trade_reporting','strategies.att1_live','strategies.asb1_live','strategies.hzbo1_live','strategies.bounce1_live']; [importlib.import_module(m) for m in mods]; print('import-check: OK')\""
echo "   ✅ files uploaded"
