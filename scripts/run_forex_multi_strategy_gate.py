...
from forex.strategies.asia_range_reversion_session_v1 import AsiaRangeReversionSessionV1, Config as AsiaRangeReversionConfig
...
from forex.strategies.failure_reclaim_session_v1 import FailureReclaimSessionV1, Config as FailureReclaimConfig
from forex.strategies.grid_reversion_session_v1 import GridReversionSessionV1, Config as GridReversionConfig
from forex.strategies.liquidity_sweep_bounce_session_v1 import (
    LiquiditySweepBounceSessionV1,
    Config as LiquiditySweepBounceConfig,
)
...
from forex.strategies.trend_retest_session_v2 import Config as TrendRetestV2Config
...
PRESETS: Dict[str, Dict[str, Dict[str, float | int]]] = {
    "trend_retest_session_v1": {
        ...
        "quality_guard": {
            ...
            "cooldown_bars": 28,
            "trend_slope_bars": 8,
            "min_ema_gap_atr": 0.35,
            "min_slow_slope_atr": 0.10,
            "max_atr_pct": 0.35,
            "min_breakout_body_atr": 0.10,
    ...
    "trend_retest_session_v2": {
        "default": {
            ...
            "cooldown_bars": 24,
            "trend_slope_bars": 8,
            "min_ema_gap_atr": 0.10,
            "min_slow_slope_atr": 0.05,
            "min_range_width_atr": 1.2,
            "max_range_width_atr": 8.0,
            "breakout_buffer_atr": 0.10,
            "min_breakout_body_atr": 0.12,
            "max_breakout_body_atr": 1.20,
            "retest_touch_atr": 0.18,
            "retest_hold_atr": 0.05,
            "min_retest_body_atr": 0.04,
            "min_retest_reject_wick_atr": 0.04,
            "max_entry_extension_atr": 0.45,
            "level_sl_pad_atr": 0.10,
            "max_risk_atr": 1.8,
        },
        "conservative": {
            "ema_fast": 48,
            ...
            "cooldown_bars": 24,
            "trend_slope_bars": 8,
            "min_ema_gap_atr": 0.18,
            "min_slow_slope_atr": 0.08,
            "min_range_width_atr": 1.4,
            "max_range_width_atr": 6.0,
            "breakout_buffer_atr": 0.12,
            "min_breakout_body_atr": 0.14,
            "max_breakout_body_atr": 0.90,
            "retest_touch_atr": 0.16,
            "retest_hold_atr": 0.06,
            "min_retest_body_atr": 0.06,
            "min_retest_reject_wick_atr": 0.06,
            "max_entry_extension_atr": 0.35,
            "level_sl_pad_atr": 0.08,
            "max_risk_atr": 1.5,
        },
        "balanced": {
            "ema_fast": 48,
            ...
            "trend_slope_bars": 8,
            "min_ema_gap_atr": 0.10,
            "min_slow_slope_atr": 0.04,
            "min_range_width_atr": 1.1,
            "max_range_width_atr": 8.0,
            "breakout_buffer_atr": 0.08,
            "min_breakout_body_atr": 0.10,
            "max_breakout_body_atr": 1.00,
            "retest_touch_atr": 0.20,
            "retest_hold_atr": 0.04,
            "min_retest_body_atr": 0.04,
            "min_retest_reject_wick_atr": 0.03,
            "max_entry_extension_atr": 0.45,
            "level_sl_pad_atr": 0.10,
            "max_risk_atr": 1.7,
        },
        "gbpjpy_core": {
            ...
            "min_slow_slope_atr": 0.06,
            "min_range_width_atr": 1.2,
            "max_range_width_atr": 7.0,
            "breakout_buffer_atr": 0.10,
            "min_breakout_body_atr": 0.12,
            "max_breakout_body_atr": 1.00,
            "retest_touch_atr": 0.18,
            "retest_hold_atr": 0.05,
            "min_retest_body_atr": 0.05,
            "min_retest_reject_wick_atr": 0.05,
    ...
    "asia_range_reversion_session_v1": {
        "default": {
            ...
            "max_ema_gap_atr": 0.55,
            "max_slow_slope_atr": 0.12,
            "max_setup_drift_atr": 0.75,
            "edge_zone_atr": 0.22,
            "reclaim_atr": 0.05,
            "min_reject_wick_atr": 0.08,
            "min_body_atr": 0.02,
        ...
        "conservative": {
            ...
            "ema_slow": 200,
            "min_range_width_atr": 1.2,
            "max_range_width_atr": 4.8,
            "max_ema_gap_atr": 0.42,
            "max_slow_slope_atr": 0.09,
            "max_setup_drift_atr": 0.55,
            "edge_zone_atr": 0.18,
            "reclaim_atr": 0.06,
            "min_reject_wick_atr": 0.10,
            "min_body_atr": 0.03,
            "max_body_atr": 0.60,
            "sl_pad_atr": 0.10,
            "tp_buffer_atr": 0.08,
        ...
        "active": {
            ...
            "ema_slow": 89,
            "min_range_width_atr": 0.8,
            "max_range_width_atr": 6.2,
            "max_ema_gap_atr": 0.75,
            "max_slow_slope_atr": 0.16,
            "max_setup_drift_atr": 0.95,
            "edge_zone_atr": 0.28,
            "reclaim_atr": 0.04,
            "min_reject_wick_atr": 0.06,
            "min_body_atr": 0.01,
    ...
    "failure_reclaim_session_v1": {
        "default": {
            ...
            "min_range_width_atr": 1.0,
            "max_range_width_atr": 6.0,
            "max_ema_gap_atr": 0.95,
            "max_slow_slope_atr": 0.20,
            "min_sweep_atr": 0.08,
            "max_sweep_atr": 0.85,
            "reclaim_close_atr": 0.04,
            "confirm_window_bars": 4,
            "min_follow_body_atr": 0.08,
            "max_entry_extension_atr": 0.45,
            "sl_pad_atr": 0.10,
            "max_risk_atr": 1.20,
            "rr": 1.6,
        ...
        "conservative": {
            ...
            "max_range_width_atr": 5.5,
            "max_ema_gap_atr": 0.75,
            "max_slow_slope_atr": 0.14,
            "min_sweep_atr": 0.10,
            "max_sweep_atr": 0.70,
            "reclaim_close_atr": 0.05,
            "confirm_window_bars": 3,
            "min_follow_body_atr": 0.10,
            "max_entry_extension_atr": 0.35,
            "sl_pad_atr": 0.10,
            "max_risk_atr": 1.00,
            "rr": 1.5,
        ...
        "active": {
            "ema_fast": 21,
            "ema_slow": 89,
            "min_range_width_atr": 0.9,
            "max_range_width_atr": 7.0,
            "max_ema_gap_atr": 1.10,
            "max_slow_slope_atr": 0.28,
            "min_sweep_atr": 0.06,
            "max_sweep_atr": 1.00,
            "reclaim_close_atr": 0.03,
            "confirm_window_bars": 5,
            "min_follow_body_atr": 0.06,
            "max_entry_extension_atr": 0.55,
            "sl_pad_atr": 0.12,
            "max_risk_atr": 1.35,
            "rr": 1.45,
            "cooldown_bars": 14,
    ...
    "liquidity_sweep_bounce_session_v1": {
        ...
        "active": {
            ...
            "max_range_width_atr": 7.0,
            "max_ema_gap_atr": 0.95,
            "max_slow_slope_atr": 0.24,
            "trend_slope_bars": 6,
            "min_sweep_atr": 0.08,
            "max_sweep_atr": 0.90,
            "reclaim_atr": 0.03,
            "min_reject_wick_atr": 0.08,
            "min_wick_to_body": 1.2,
            "max_body_atr": 0.55,
            "sl_pad_atr": 0.15,
            "max_risk_atr": 1.20,
            "rr": 1.45,
    ...
    "trend_pullback_rebound_v1": {
        ...
        "quality_guard": {
            ...
            "min_slow_slope_atr": 0.08,
            "max_atr_pct": 0.45,
            "min_rebound_body_atr": 0.06,
            "max_pullthrough_slow_atr": 0.15,
        },
    },
}
...
def _build_strategy(name: str, session_start: int, session_end: int):
    ...
    if base_name == "trend_retest_session_v1":
        return TrendRetestSessionV1(
            TrendRetestConfig(
                ...
                trend_slope_bars=int(p.get("trend_slope_bars", 8)),
                min_ema_gap_atr=float(p.get("min_ema_gap_atr", 0.0)),
                min_slow_slope_atr=float(p.get("min_slow_slope_atr", 0.0)),
                max_atr_pct=float(p.get("max_atr_pct", 0.0)),
                min_breakout_body_atr=float(p.get("min_breakout_body_atr", 0.0)),
                max_entry_extension_atr=float(p.get("max_entry_extension_atr", 0.0)),
            )
        )
    if base_name == "trend_retest_session_v2":
        return TrendRetestSessionV2(
            TrendRetestV2Config(
                ...
                min_ema_gap_atr=float(p.get("min_ema_gap_atr", 0.0)),
                min_slow_slope_atr=float(p.get("min_slow_slope_atr", 0.0)),
                min_range_width_atr=float(p.get("min_range_width_atr", 0.0)),
                max_range_width_atr=float(p.get("max_range_width_atr", 999.0)),
                max_atr_pct=float(p.get("max_atr_pct", 0.0)),
                breakout_buffer_atr=float(p.get("breakout_buffer_atr", 0.10)),
                min_breakout_body_atr=float(p.get("min_breakout_body_atr", 0.0)),
                max_breakout_body_atr=float(p.get("max_breakout_body_atr", 999.0)),
                retest_touch_atr=float(p.get("retest_touch_atr", 0.18)),
                retest_hold_atr=float(p.get("retest_hold_atr", 0.05)),
                min_retest_body_atr=float(p.get("min_retest_body_atr", 0.0)),
                min_retest_reject_wick_atr=float(p.get("min_retest_reject_wick_atr", 0.0)),
                max_entry_extension_atr=float(p.get("max_entry_extension_atr", 999.0)),
                level_sl_pad_atr=float(p.get("level_sl_pad_atr", 0.10)),
                max_risk_atr=float(p.get("max_risk_atr", 999.0)),
            )
        )
    ...
    if base_name == "asia_range_reversion_session_v1":
        return AsiaRangeReversionSessionV1(
            AsiaRangeReversionConfig(
                ema_fast=int(p["ema_fast"]),
                ema_slow=int(p["ema_slow"]),
                min_range_width_atr=float(p["min_range_width_atr"]),
                max_range_width_atr=float(p["max_range_width_atr"]),
                max_ema_gap_atr=float(p["max_ema_gap_atr"]),
                max_slow_slope_atr=float(p["max_slow_slope_atr"]),
                max_setup_drift_atr=float(p["max_setup_drift_atr"]),
                edge_zone_atr=float(p["edge_zone_atr"]),
                reclaim_atr=float(p["reclaim_atr"]),
                min_reject_wick_atr=float(p["min_reject_wick_atr"]),
                min_body_atr=float(p["min_body_atr"]),
                max_body_atr=float(p["max_body_atr"]),
                sl_pad_atr=float(p["sl_pad_atr"]),
                tp_buffer_atr=float(p["tp_buffer_atr"]),
    ...
    if base_name == "failure_reclaim_session_v1":
        return FailureReclaimSessionV1(
            FailureReclaimConfig(
                ema_fast=int(p["ema_fast"]),
                ema_slow=int(p["ema_slow"]),
                min_range_width_atr=float(p["min_range_width_atr"]),
                max_range_width_atr=float(p["max_range_width_atr"]),
                max_ema_gap_atr=float(p["max_ema_gap_atr"]),
                max_slow_slope_atr=float(p["max_slow_slope_atr"]),
                min_sweep_atr=float(p["min_sweep_atr"]),
                max_sweep_atr=float(p["max_sweep_atr"]),
                reclaim_close_atr=float(p["reclaim_close_atr"]),
                confirm_window_bars=int(p["confirm_window_bars"]),
                min_follow_body_atr=float(p["min_follow_body_atr"]),
                max_entry_extension_atr=float(p["max_entry_extension_atr"]),
                sl_pad_atr=float(p["sl_pad_atr"]),
                max_risk_atr=float(p["max_risk_atr"]),
                rr=float(p["rr"]),
                cooldown_bars=int(p["cooldown_bars"]),
                session_utc_start=session_start,
                session_utc_end=session_end,
    ...
    if base_name == "liquidity_sweep_bounce_session_v1":
        return LiquiditySweepBounceSessionV1(
            LiquiditySweepBounceConfig(
                ema_fast=int(p["ema_fast"]),
                ema_slow=int(p["ema_slow"]),
                sweep_lookback=int(p["sweep_lookback"]),
                min_range_width_atr=float(p["min_range_width_atr"]),
                max_range_width_atr=float(p["max_range_width_atr"]),
                max_ema_gap_atr=float(p["max_ema_gap_atr"]),
                max_slow_slope_atr=float(p["max_slow_slope_atr"]),
                trend_slope_bars=int(p["trend_slope_bars"]),
                min_sweep_atr=float(p["min_sweep_atr"]),
                max_sweep_atr=float(p["max_sweep_atr"]),
                reclaim_atr=float(p["reclaim_atr"]),
                min_reject_wick_atr=float(p["min_reject_wick_atr"]),
                min_wick_to_body=float(p["min_wick_to_body"]),
                max_body_atr=float(p["max_body_atr"]),
                sl_pad_atr=float(p["sl_pad_atr"]),
                max_risk_atr=float(p["max_risk_atr"]),
                rr=float(p["rr"]),
    ...
    if base_name == "trend_pullback_rebound_v1":
        return TrendPullbackReboundV1(
            TrendPullbackConfig(
                ...
                min_slow_slope_atr=float(p.get("min_slow_slope_atr", 0.0)),
                max_atr_pct=float(p.get("max_atr_pct", 0.0)),
                min_rebound_body_atr=float(p.get("min_rebound_body_atr", 0.0)),
                max_pullthrough_slow_atr=float(p.get("max_pullthrough_slow_atr", 0.0)),
            )
        )
    raise ValueError(f"Unsupported strategy: {base_name}")
