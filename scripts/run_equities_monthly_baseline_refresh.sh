...
# 30-stock cross-sector universe (expanded 2026-05-26)
# Screener picks top-2 by momentum — more candidates = better picks
CORE_TICKERS="${EQ_BASELINE_CORE_TICKERS:-AAPL,MSFT,NVDA,GOOGL,META,AMZN,TSLA,AVGO,AMD,CRM,ADBE,CRWD,PANW,JPM,GS,V,MA,UNH,LLY,XOM,CVX,CAT,HON,WMT,COST,NFLX,UBER,ABBV,MRK,NOW}"
BENCH_TICKERS="${EQ_BASELINE_BENCH_TICKERS:-SPY,QQQ}"
ALL_FETCH_TICKERS="${EQ_BASELINE_FETCH_TICKERS:-${CORE_TICKERS},${BENCH_TICKERS}}"
