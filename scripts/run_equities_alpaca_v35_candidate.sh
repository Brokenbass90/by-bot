...
CANDIDATE_ENV="${ALPACA_CANDIDATE_ENV:-$ROOT/configs/alpaca_paper_v35_candidate.env}"
...
OVERRIDE_EQ_V35_DYNAMIC_UNIVERSE="${EQ_V35_DYNAMIC_UNIVERSE-}"
...
if [[ -n "$OVERRIDE_EQ_V35_DYNAMIC_UNIVERSE" ]]; then
  export EQ_V35_DYNAMIC_UNIVERSE="$OVERRIDE_EQ_V35_DYNAMIC_UNIVERSE"
fi
