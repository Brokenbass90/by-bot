...
def main() -> int:
    ...
    ap.add_argument("--max-autoresearch-age-sec", type=int, default=int(os.getenv("RESEARCH_MAX_AUTORESEARCH_AGE_SEC", "21600")))
    ap.add_argument("--max-backtest-age-sec", type=int, default=int(os.getenv("RESEARCH_MAX_BACKTEST_AGE_SEC", "7200")))
