...
export ALPACA_INTRADAY_DYNAMIC_ENV="${ALPACA_INTRADAY_DYNAMIC_ENV:-$ROOT/configs/alpaca_intraday_dynamic_v3_shadow.env}"
export EQ_ANNUAL_RUN_SUFFIX="${EQ_ANNUAL_RUN_SUFFIX:-alpaca_dyn_v3_shadow_annual}"
